...
public class KundeDao extends AbstractDao<Kunde, Long> {
	...
	/**
	 */
	public List<Kunde> findKundenByName(String nachname, FetchType fetch) {
		List<Kunde> kunden = null;
	...
	public void fetchLieferungen(List<Kunde> kunden) {
		...
		b.fetch(Bestellung_.versand, JoinType.LEFT);
		...
		if (!predList.isEmpty()) {
			...
			// Ergebnis der Query nicht relevant, da nur Fetching benoetigt wird
		}
	}
